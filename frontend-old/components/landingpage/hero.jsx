...
const Hero = () => {
    return (
        <div className="relative overflow-hidden text-white min-h-screen flex items-center pt-24">
            ...
            <div className="container relative mx-auto px-4 sm:px-6 h-full flex items-center justify-center z-10">
                ...
                <div className="text-center max-w-5xl mx-auto">
                    ...
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-indigo-200 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-2">
                        Open-source platform to create, deploy, and share
                        intelligent AI agents. From customer service to personal
                        assistants - build any AI agent with our collaborative,
