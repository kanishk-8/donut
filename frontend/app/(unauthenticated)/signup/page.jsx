                ...
                <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 py-6">
                    <div className="max-w-lg mx-auto">
                        ...
                        <p className="text-xl text-indigo-200 mb-8 leading-relaxed">
                            Deploy intelligent customer service agents that
                            handle queries, solve problems, and provide 24/7
                            support. Voice & chat agents ready in minutes.
                        </p>
                        <div className="space-y-4 text-indigo-200">
                            <div className="flex items-center">
                                <div className="w-2 h-2 bg-indigo-400 rounded-full mr-3"></div>
                                <span>
                                    Deploy chat & voice agents instantly
                                </span>
                            </div>
                            <div className="flex items-center">
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div className="text-center mb-8 lg:hidden">
                            ...
                            <p className="text-gray-400">
                                Start building intelligent customer service
                                agents today
                            </p>
                        </div>
