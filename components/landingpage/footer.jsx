      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-2 md:col-span-4">
            <div className="flex items-center gap-2 mb-6">
              <Image src="/logo.png" alt="Donut logo" width={40} height={40} />
              <div className="flex flex-col">
                <span className="text-2xl font-bold">donut</span>
                <span className="text-sm text-indigo-300">by me</span>
              </div>
            </div>
            <p className="text-indigo-200 mb-6 max-w-md">
              Building the future of AI automation, one agent at a time. Join
              our community of early adopters and shape the next generation of
              no-code AI.
            </p>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            <Link href="/status" className="text-indigo-200 hover:text-white">
              System Status
            </Link>
            <Link href="/sitemap" className="text-indigo-200 hover:text-white">
              Sitemap
            </Link>
